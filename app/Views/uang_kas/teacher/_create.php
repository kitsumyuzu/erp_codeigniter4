                <div class="main-panel">
                    <div class="content-wrapper">
                        ...
                        <form action="/Kas/create_teacher" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" id="nik" name="nik" placeholder="1234567890" maxlength="20">
                                                </div>
                                                <div class="form-group col-md-4">
